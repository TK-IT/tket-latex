...
\filnavn{tket.tds.zip}, som indeholder alle de nødvendige filer. Den nyeste
version kan hentes fra \url{https://github.com/TK-IT/tket-latex/releases}.

Den skal du pakke ud i roden af et \enquote{lokalt texmf-træ}. Hvor og hvordan
du finder den mappe afhænger af din \TeX-distribution (\mbox{\TeX{}
...
\meta{\%USERPROFILE\%}{\ttfamily \textbackslash texmf}.

På et Linux-agtigt system er det formentlig \nolinkurl{~/texmf}.

På macOS er \href{http://www.tug.org/mactex/faq/#qm04}{det formentligt}
\nolinkurl{~/Library/texmf}.

Du kan forvisse dig om den rigtige værdi ved at køre kommandoen {\ttfamily
...
rigtige mappe \href{http://www.tug.org/mactex/faq/#qm04}{i dette
tilfælde} \nolinkurl{~/Library/texmf}.
